...
const App = {
    ...
    updateNavVisibility() {
        ...
        const housesNav = document.getElementById('nav-houses');
        const housesBottomNav = document.getElementById('bottom-nav-houses');
        if (!Auth.can('houses.view')) {
            if (housesNav) housesNav.classList.add('hidden');
            if (housesBottomNav) housesBottomNav.classList.add('hidden');
        } else {
            if (housesNav) housesNav.classList.remove('hidden');
            if (housesBottomNav) housesBottomNav.classList.remove('hidden');
        }

        const masterkeysNav = document.getElementById('nav-masterkeys');
        const masterkeysBottomNav = document.getElementById('bottom-nav-masterkeys');
        if (!Auth.can('masterkeys.view')) {
            if (masterkeysNav) masterkeysNav.classList.add('hidden');
            if (masterkeysBottomNav) masterkeysBottomNav.classList.add('hidden');
        } else {
            if (masterkeysNav) masterkeysNav.classList.remove('hidden');
            if (masterkeysBottomNav) masterkeysBottomNav.classList.remove('hidden');
        }
    },
