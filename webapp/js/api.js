...
const API = {
    ...
    async getDevices(adminEmail) {
        const params = {};
        if (adminEmail) params.admin_email = adminEmail;
        return this.get('getDevices', params);
    },
    ...
    async getHouses() {
        return this.get('getHouses');
    },

    async getHouse(houseId) {
        return this.get('getHouse', { house_id: houseId });
    },

    async createHouse(houseData) {
        return this.post('createHouse', houseData);
    },

    async updateHouse(houseId, houseData) {
        return this.post('updateHouse', { house_id: houseId, ...houseData });
    },

    async deleteHouse(houseId) {
        return this.post('deleteHouse', { house_id: houseId });
    },

    // ==================== ADMIN HOUSES ====================

    async getAdminHouses(email) {
        return this.get('getAdminHouses', { email });
    },

    async getAllAdminHouses() {
        return this.get('getAllAdminHouses');
    },

    async assignAdminHouses(adminEmail, houseIds) {
        return this.post('assignAdminHouses', { admin_email: adminEmail, house_ids: houseIds });
    },

    async assignHouseAdmin(houseId, adminEmail) {
    ...
    async getMasterkeys() {
        return this.get('getMasterkeys');
    },

    async getMasterkeysForDevice(esp32Id) {
        return this.get('getMasterkeysForDevice', { esp32_id: esp32Id });
    },

    async createMasterkey(masterkeyData) {
        return this.post('createMasterkey', masterkeyData);
    },

    async updateMasterkey(masterkeyId, masterkeyData) {
        return this.post('updateMasterkey', { masterkey_id: masterkeyId, ...masterkeyData });
    },

    async deleteMasterkey(masterkeyId) {
        return this.post('deleteMasterkey', { masterkey_id: masterkeyId });
    },
