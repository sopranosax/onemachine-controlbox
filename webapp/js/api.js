 ...
 * 
 * Note: Google Apps Script uses a single endpoint with 'action' parameter
 * GET requests use URL params, POST requests use JSON body with action field
 */
...
const API = {
    ...
    async validateAdmin(email) {
        return this.post('validateAdmin', { email });
    },
