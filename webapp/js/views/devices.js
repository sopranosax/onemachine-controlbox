...
const Devices = {
    ...
    async loadDevices() {
        try {
            ...
            // Mock data
            this.devices = [
                { esp32_id: 'AA:BB:CC:DD:EE:01', location: 'Lavandería Piso 1', active: true, token_type: 'WSH', wifi_ssid: 'IoT_Network', wifi_psswd: 'secret123', reconnect_sec: 30, time_limit_min: 45, last_seen: new Date().toISOString() },
                { esp32_id: 'AA:BB:CC:DD:EE:02', location: 'Lavandería Piso 2', active: true, token_type: 'DRY', wifi_ssid: 'IoT_Network', wifi_psswd: 'secret123', reconnect_sec: 30, time_limit_min: 60, last_seen: new Date(Date.now() - 600000).toISOString() },
                { esp32_id: 'AA:BB:CC:DD:EE:03', location: 'Gimnasio', active: false, token_type: 'GYM', wifi_ssid: 'GYM_WiFi', wifi_psswd: 'gym456', reconnect_sec: 60, time_limit_min: 30, last_seen: new Date(Date.now() - 3600000).toISOString() }
            ];
            this.renderDevices(this.devices);
        }
    },
                ...
                <div class="device-card">
                    ...
                    <div class="device-info">
                        <div class="device-info-item">
                            ...
                            <span class="device-info-value">${device.token_type}</span>
                        </div>
                        <div class="device-info-item">
